...
public class A_Variable {
	...
	//	int int
		...
		//암묵적 룰
		//띄어쓰기 표현
		// - Camel case : 띄어쓰기를 표현할 때 띄워쓰기를 제거하고 바로 뒤 문자를 대문자료 표현
		// - Snake case : 띄워쓰기를 표현할 때 띄어쓰기를 자리에 _ 로 표현
		String smartPhone;
		String smart_phone;
		...
		// MAX = 200; 
		 ...
		 final double IPHON_15_PRO_HEIGHT = 146.6;
		 final double IPHON_15_PRO_WEIGHT = 70.6;
		 
		 double size2 = IPHON_15_PRO_HEIGHT * IPHON_15_PRO_WEIGHT;
